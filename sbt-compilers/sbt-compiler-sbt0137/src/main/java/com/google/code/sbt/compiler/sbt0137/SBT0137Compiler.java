...
/**
 * SBT 0.13.7 compatible compiler (uses <a href="https://github.com/typesafehub/zinc">Zinc</a> 0.3.7)
 * 
    ...
    extends AbstractCompiler
{
    ...
    {
        Logger sbtLogger = new SBT0137Logger( configuration.getLogger() );
        Setup setup =
            Setup.create( configuration.getScalaCompilerFile(), configuration.getScalaLibraryFile(),
                          ...
                          configuration.getCompilerInterfaceSrcFile(), null, SBT0137Compiler.FORK_JAVA );
        ...
        Inputs inputs =
            Inputs.create( configuration.getClasspathFiles(), configuration.getSourceFiles(),
                           ...
                           configuration.getAnalysisCacheMap(), SBT0137Compiler.COMPILE_ORDER, getIncOptions(),
        ...
        try
        {
            return new SBT0137Analysis( compiler.compile( inputs, sbtLogger ) );
        }
