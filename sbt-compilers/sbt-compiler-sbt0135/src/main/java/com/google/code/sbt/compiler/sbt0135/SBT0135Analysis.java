...
/**
 * SBT 0.13.5 compatible incremental compilation analysis
 * 
 * @author <a href="mailto:gslowikowski@gmail.com">Grzegorz Slowikowski</a>
 */
public class SBT0135Analysis
    implements Analysis
{
    ...
    @Override
    public void writeToFile( File analysisFile )//use Zinc method (if there is any)?
    {
