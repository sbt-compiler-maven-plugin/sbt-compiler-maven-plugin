...
package com.google.code.sbt.compiler.sbt0135;
...
/**
 * SBT 0.13.5 compatible compiler (uses <a href="https://github.com/typesafehub/zinc">Zinc</a> 0.3.5.3)
 * 
 * @author <a href="mailto:gslowikowski@gmail.com">Grzegorz Slowikowski</a>
 */
@Component( role = com.google.code.sbt.compiler.api.Compiler.class, hint = "sbt0135", description = "SBT 0.13.5 compiler (uses Zinc 0.3.5.3)" )
public class SBT0135Compiler
    extends AbstractCompiler
{
    ...
    {
        Logger sbtLogger = new SBT0135Logger( configuration.getLogger() );
        Setup setup =
            Setup.create( configuration.getScalaCompilerFile(), configuration.getScalaLibraryFile(),
                          ...
                          configuration.getCompilerInterfaceSrcFile(), null, SBT0135Compiler.FORK_JAVA );
        ...
        Inputs inputs =
            Inputs.create( configuration.getClasspathFiles(), configuration.getSourceFiles(),
                           ...
                           configuration.getAnalysisCacheMap(), SBT0135Compiler.COMPILE_ORDER, getIncOptions(),
        ...
        try
        {
            return new SBT0135Analysis( compiler.compile( inputs, sbtLogger ) );
        }
