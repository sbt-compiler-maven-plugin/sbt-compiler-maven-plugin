...
/**
 * SBT 0.13.9 compatible analysis processor
 * 
 * @author <a href="mailto:gslowikowski@gmail.com">Grzegorz Slowikowski</a>
 */
@Component( role = AnalysisProcessor.class, hint = "sbt0139", description = "SBT 0.13.9 analysis processor" )
public class SBT0139AnalysisProcessor
    implements AnalysisProcessor
{
    ...
    {
        return new SBT0139Analysis( Compiler$.MODULE$.analysis( analysisCacheFile ) );
    }
