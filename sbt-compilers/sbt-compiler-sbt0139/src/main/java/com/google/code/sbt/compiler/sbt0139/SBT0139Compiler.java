...
package com.google.code.sbt.compiler.sbt0139;
...
/**
 * SBT 0.13.9 compatible compiler (uses <a href="https://github.com/typesafehub/zinc">Zinc</a> 0.3.9)
 * 
 * @author <a href="mailto:gslowikowski@gmail.com">Grzegorz Slowikowski</a>
 */
@Component( role = com.google.code.sbt.compiler.api.Compiler.class, hint = "sbt0139", description = "SBT 0.13.9 compiler (uses Zinc 0.3.9)" )
public class SBT0139Compiler
    extends AbstractCompiler
{
    ...
    {
        Logger sbtLogger = new SBT0139Logger( configuration.getLogger() );
        Setup setup =
            Setup.create( configuration.getScalaCompilerFile(), configuration.getScalaLibraryFile(),
                          ...
                          configuration.getCompilerInterfaceSrcFile(), null, SBT0139Compiler.FORK_JAVA );
        ...
        Inputs inputs =
            Inputs.create( configuration.getClasspathFiles(), configuration.getSourceFiles(),
                           ...
                           configuration.getAnalysisCacheMap(), SBT0139Compiler.COMPILE_ORDER, getIncOptions(),
        ...
        try
        {
            return new SBT0139Analysis( compiler.compile( inputs, sbtLogger ) );
        }
