    ...
    extends AbstractCompiler
{
    ...
    {
        Logger sbtLogger = new SBT0136Logger( configuration.getLogger() );
        Setup setup =
            Setup.create( configuration.getScalaCompilerFile(), configuration.getScalaLibraryFile(),
                          ...
                          configuration.getCompilerInterfaceSrcFile(), null, SBT0136Compiler.FORK_JAVA );
        ...
        Inputs inputs =
            Inputs.create( configuration.getClasspathFiles(), configuration.getSourceFiles(),
                           ...
                           configuration.getAnalysisCacheMap(), SBT0136Compiler.COMPILE_ORDER, getIncOptions(),
        ...
        try
        {
            return new SBT0136Analysis( compiler.compile( inputs, sbtLogger ) );
        }
