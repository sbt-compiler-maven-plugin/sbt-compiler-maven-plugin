...
/**
 * SBT 0.13.8 compatible analysis processor
 * 
 * @author <a href="mailto:gslowikowski@gmail.com">Grzegorz Slowikowski</a>
 */
@Component( role = AnalysisProcessor.class, hint = "sbt0138", description = "SBT 0.13.8 analysis processor" )
public class SBT0138AnalysisProcessor
    implements AnalysisProcessor
{
    ...
    {
        return new SBT0138Analysis( Compiler$.MODULE$.analysis( analysisCacheFile ) );
    }
