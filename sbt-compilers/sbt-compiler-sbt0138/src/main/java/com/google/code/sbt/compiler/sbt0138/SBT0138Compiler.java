...
package com.google.code.sbt.compiler.sbt0138;
...
/**
 * SBT 0.13.8 compatible compiler (uses <a href="https://github.com/typesafehub/zinc">Zinc</a> 0.3.8.1)
 * 
 * @author <a href="mailto:gslowikowski@gmail.com">Grzegorz Slowikowski</a>
 */
@Component( role = com.google.code.sbt.compiler.api.Compiler.class, hint = "sbt0138", description = "SBT 0.13.8 compiler (uses Zinc 0.3.8.1)" )
public class SBT0138Compiler
    extends AbstractCompiler
{
    ...
    {
        Logger sbtLogger = new SBT0138Logger( configuration.getLogger() );
        Setup setup =
            Setup.create( configuration.getScalaCompilerFile(), configuration.getScalaLibraryFile(),
                          ...
                          configuration.getCompilerInterfaceSrcFile(), null, SBT0138Compiler.FORK_JAVA );
        ...
        Inputs inputs =
            Inputs.create( configuration.getClasspathFiles(), configuration.getSourceFiles(),
                           ...
                           configuration.getAnalysisCacheMap(), SBT0138Compiler.COMPILE_ORDER, getIncOptions(),
        ...
        try
        {
            return new SBT0138Analysis( compiler.compile( inputs, sbtLogger ) );
        }
