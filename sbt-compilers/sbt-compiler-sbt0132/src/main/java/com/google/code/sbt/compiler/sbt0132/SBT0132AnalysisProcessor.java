 ...
 */
@Component( role = AnalysisProcessor.class, hint = "sbt0132", description = "SBT 0.13.2 analysis processor" )
    ...
    implements AnalysisProcessor
{
    ...
    {
        return new SBT0132Analysis( Compiler$.MODULE$.analysis( analysisCacheFile ) );
    }
